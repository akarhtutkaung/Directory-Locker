...
public class lock {
   ...
   public static void main(String args[]) {
      if (args.length != 8) {
         ...
         System.out.println("[directory]   : directory path to lock");
         System.out.println("[public key]  : the unlock party public key path with the key name and extension");
         System.out.println("[private key] : the lock party private key path with the key name and extension");
         System.out.println("[subject]     : subject inside the unlock party's public key");
         System.exit(0);
      }
