...
public class unlock {
   ...
   public static void main(String args[]) {
      if (args.length != 8) {
         ...
         System.out.println("[directory]   : directory path to unlock");
         System.out.println("[public key]  : the lock party public key path with the key name and extension");
         System.out.println("[private key] : the unlock party private key path with the key name and extension");
         System.out.println("[subject]     : subject inside the lock party public key path");
         System.exit(0);
      }
